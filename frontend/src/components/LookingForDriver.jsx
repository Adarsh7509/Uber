...
const LookingForDriver = (props) => {
  return (
    <div>
      ...
      >
        <i className="font-bold text-lg  ri-arrow-down-wide-line "></i>
      </h5>
      <h3 className="text-xl font-semibold mb-3 ml-5 mt-3">Looking for a Driver</h3>
      <div className="flex gap-2 justify-between items-center flex-col mb-4 ">
        <img
          className="h-20"
