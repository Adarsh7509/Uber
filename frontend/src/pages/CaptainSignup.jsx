        ...
        <div>
          ...
          <form onSubmit={(e) => { submitHandler(e) }}>
            ...
            <div className='flex gap-4 mb-5'>
              <input required className='bg-[#eeee]  w-1/2 rounded px-4 py-2 border  text-base placeholder:text-base' type="text" placeholder="First Name" value={firstname} onChange={(e) => { setFirstName(e.target.value) }} />
              <input required className='bg-[#eeee]  w-1/2 rounded px-4 py-2 border  text-base placeholder:text-base' type="text" placeholder="Last Name" value={lastName} onChange={(e) => { setLastName(e.target.value) }} />
            </div>
            <h3 className='text-base font-medium mb-2'>What's your email?</h3>
            <input required className='bg-[#eeee] mb-5 rounded px-4 py-2 border w-full text-base placeholder:text-base' type="email" placeholder="Enter your Email" value={email} onChange={(e) => { setEmail(e.target.value) }} />
            <h3 className='text-base font-medium mb-2'>Enter Password</h3>
            <input required className='bg-[#eeee] mb-5 rounded px-4 py-2 border w-full text-base placeholder:text-base' type="password" placeholder="Enter your Password" value={password} onChange={(e) => { setPassword(e.target.value) }} />
          
            <h3 className='text-base font-medium mb-2'>Vehicle Details</h3>
            <input
              required
              className='bg-[#eeee] mb-5 rounded  w-1/2 rounded px-4 py-2 border border text-base placeholder:text-base'
              type="text"
            ...
            <input
              required
              className='bg-[#eeee]  w-1/2 rounded px-4 py-2 border  text-base placeholder:text-base'
              type="text"
            ...
            <input
              required
              className='bg-[#eeee]  w-1/2 rounded px-4 py-2 border border  text-base placeholder:text-base'
              type="number"
            ...
            <select
              required
              className='bg-[#eeee]  w-1/2 rounded px-4 py-2 border border text-base'
              value={vehicleType}
            ...
            <button className='bg-[#111]  text-white font-semibold mb-7 mt-5 rounded px-4 py-2 border w-full text-base placeholder:text-base'>Create account</button>
            <p className='text-center'>Alredy have a account? <Link to='/captain-login' className='mb-5 text-blue-600'>login here</Link> </p>
          </form>
        </div>
        <div>
          <p className='text-[10px] mt-3 leading-tight'>This site is protected by reCAPTCHA and the <span className='underline'>Google privacy policy</span> and <span className='underline'>Terms of Service</span> apply.</p>
